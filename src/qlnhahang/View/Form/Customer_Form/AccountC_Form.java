...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new qlnhahang.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new qlnhahang.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new qlnhahang.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new qlnhahang.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new qlnhahang.View.Swing.MyTextField();
    ...
    private qlnhahang.View.Swing.MyTextField txtdiemtl;
    private qlnhahang.View.Swing.MyTextField txtdso;
    private qlnhahang.View.Swing.MyTextField txtemail;
    private qlnhahang.View.Swing.MyTextField txtmaKH;
    private qlnhahang.View.Swing.MyPasswordField txtmatkhau;
    private qlnhahang.View.Swing.MyTextField txtngayTG;
    private qlnhahang.View.Swing.MyTextField txtrole;
    private qlnhahang.View.Swing.MyTextField txttenKH;
