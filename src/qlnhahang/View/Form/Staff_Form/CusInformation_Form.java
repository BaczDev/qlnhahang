...
public class CusInformation_Form extends javax.swing.JPanel {
        ...
        try {
            ...
            for (ModelKhachHang data : list) {
                tableKH.addRow(new Object[]{
                    data.getID_KH(),
                    data.getName(),
                    data.getPhone(), // Thêm dòng này
                    data.getDateJoin(),
                    df.format(data.getSales()) + "đ",
                    data.getPoints() + " xu"
                });
            }
    ...
    public void searchTable(String txt) {
        ...
        for (ModelKhachHang data : list) {
            ...
            boolean matchesName = name != null && name.toLowerCase().contains(txt.toLowerCase());
            boolean matchesPhone = phone != null && phone.contains(txt);
            if (matchesName || matchesPhone) {
                tableKH.addRow(new Object[]{
                    data.getID_KH(),
                    name != null ? name : "", // Xử lý name null
                    phone != null ? phone : "", // Xử lý SDT null
                    data.getDateJoin(),
                    df.format(data.getSales()) + "đ",
                    data.getPoints() + " xu"
                });
    ...
    private void initComponents() {
        ...
        tableKH = new qlnhahang.View.Swing.Table();
        ...
        tableKH.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã KH", "Tên khách hàng", "SĐT", "Ngày tham gia", "Doanh số", "Điểm tích lũy"
            }
        ) {
    ...
    private qlnhahang.View.Swing.Table tableKH;
