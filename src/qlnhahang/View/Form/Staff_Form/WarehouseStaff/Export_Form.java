...
public class Export_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtslPXK = new qlnhahang.View.Swing.MyTextField();
        lbPXK = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablePXK = new qlnhahang.View.Swing.Table();
        cmdAdd = new qlnhahang.View.Swing.Button();
        cmdCT = new qlnhahang.View.Swing.Button();
    ...
    private qlnhahang.View.Swing.Button cmdCT;
    ...
    private qlnhahang.View.Swing.Table tablePXK;
    private qlnhahang.View.Swing.MyTextField txtSearch;
    private qlnhahang.View.Swing.MyTextField txtslPXK;
