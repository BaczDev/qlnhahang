...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtprofit = new qlnhahang.View.Swing.MyTextField();
        lbCus = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableHD = new qlnhahang.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        filter = new javax.swing.JComboBox<>();
        cmdCTHD = new qlnhahang.View.Swing.Button();
        cmdExcel = new qlnhahang.View.Swing.Button();
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        // Xuất danh sách Hóa Đơn ra file Excel bằng Apache POI
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            System.out.println("Đã lưu file Excel tại: " + absolutePath);
            obj.ExportFileSuccess(absolutePath);
    ...
    private qlnhahang.View.Swing.Button cmdCTHD;
    private qlnhahang.View.Swing.Button cmdExcel;
    ...
    private qlnhahang.View.Swing.Table tableHD;
    private qlnhahang.View.Swing.MyTextField txtSearch;
    private qlnhahang.View.Swing.MyTextField txtprofit;
