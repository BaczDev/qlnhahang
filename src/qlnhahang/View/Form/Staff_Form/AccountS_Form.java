package qlnhahang.View.Form.Staff_Form;
...
import qlnhahang.View.Dialog.MS_ChangePassword;
import qlnhahang.View.Dialog.MS_ConfirmRename;
import qlnhahang.View.Main_Frame.Main_Customer_Frame;
import qlnhahang.View.Main_Frame.Main_Staff_Frame;
...
private MS_ChangePassword changepass;
    ...
    private void initComponents() {
        ...
        txtngVL = new qlnhahang.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new qlnhahang.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new qlnhahang.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new qlnhahang.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new qlnhahang.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new qlnhahang.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new qlnhahang.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new qlnhahang.View.Swing.MyTextField();
        txtSDT = new qlnhahang.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new qlnhahang.View.Swing.MyTextField();
    ...
    private qlnhahang.View.Swing.Button cmdDMK;
    ...
    private qlnhahang.View.Swing.MyTextField txtCvu;
    private qlnhahang.View.Swing.MyTextField txtMaNQL;
    private qlnhahang.View.Swing.MyTextField txtSDT;
    private qlnhahang.View.Swing.MyTextField txtemail;
    private qlnhahang.View.Swing.MyTextField txtmaNV;
    private qlnhahang.View.Swing.MyPasswordField txtmatkhau;
    private qlnhahang.View.Swing.MyTextField txtngVL;
    private qlnhahang.View.Swing.MyTextField txtrole;
    private qlnhahang.View.Swing.MyTextField txttenNV;
