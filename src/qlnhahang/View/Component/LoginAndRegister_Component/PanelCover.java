...
import qlnhahang.View.Swing.ImageLogo;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        logo.setIcon(new ImageIcon(getClass().getResource("/Icons/logo_login_register.png")));
        add(logo);
        
        title= new JLabel("Chào mừng bạn đến với nhà hàng");
        title.setFont(new Font("sansserif",1,18));
        title.setForeground(new Color(121, 14, 14));
        add(title);
        
        subtitle= new JLabel("XIAO LONG BAO");
        subtitle.setFont(new Font("sansserif",1,28));
        subtitle.setForeground(new Color(121, 14, 14));
        add(subtitle);
        
        description = new JLabel("Để sử dụng dịch vụ tại đây vui lòng");
        description.setForeground(new Color(121, 14, 14));
        add(description);
        
        description1 = new JLabel("đăng nhập với tài khoản cá nhân của bạn");
        description1.setForeground(new Color(121, 14, 14));
        add(description1);
        
        button = new ButtonOutLine();
        button.setBackground(new Color(255,255,255));
        button.setForeground(new Color(121, 14, 14));
   ...
   @Override
    protected void paintComponent(Graphics g) {
        ...
        g2.setColor(Color.decode("#F8E7D0"));
