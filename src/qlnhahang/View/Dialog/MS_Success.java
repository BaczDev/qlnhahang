...
public class MS_Success extends javax.swing.JDialog {
    ...
    public void showAddFoodSuccess() {
        setLocationRelativeTo(frame);
        lbTitle.setText("THÊM MÓN ĂN THÀNH CÔNG!");
        animator.start();
        setVisible(true);
    }
    
    public void showUpdateFoodSuccess() {
        setLocationRelativeTo(frame);
        lbTitle.setText("SỬA MÓN ĂN THÀNH CÔNG!");
        animator.start();
        setVisible(true);
    }
    
    public void showAddStaffSuccess() {
        setLocationRelativeTo(frame);
        lbTitle.setText("THÊM NHÂN VIÊN THÀNH CÔNG!");
        animator.start();
        setVisible(true);
    }
    
    public void showUpdateStaffSuccess() {
        setLocationRelativeTo(frame);
        lbTitle.setText("SỬA NHÂN VIÊN THÀNH CÔNG!");
        animator.start();
        setVisible(true);
    }
