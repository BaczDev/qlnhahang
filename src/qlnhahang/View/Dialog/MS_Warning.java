...
public class MS_Warning extends javax.swing.JDialog {
    ...
    // Hiện cảnh báo không đủ số lượng nguyên liệu để xuất kho
    public void WarningNotEnoughStock(String tenNL) {
        setLocationRelativeTo(frame);
        lbTitle.setText("KHÔNG ĐỦ SỐ LƯỢNG!");
        lbMessage.setText("Nguyên liệu '" + tenNL + "' không đủ số lượng để xuất kho.");
        animator.start();
        setVisible(true);
    }
    ...
    void Warning(String hóa_đơn_hoặc_voucher_không_hợp_lệ) {
